...
from data.jsonl_dataset import get_csnjs_dataset, normalize_docstring#, JSONLinesDataset
...
def make_corpus(input=DEFAULT_INPUT, output=DEFAULT_OUTPUT, label_mode="identifier"):
    dataset = get_csnjs_dataset(input, label_mode, -1)#JSONLinesDataset(input, {"function": "function", "docstring": "docstring"})
